...
PreprocessingStep: TypeAlias = Callable[[tf.Tensor, tf.Tensor], tuple[tf.Tensor, tf.Tensor]]
...
class PreprocessingPipeline:
    ...
    def _pixel_value_normalization(self, image: tf.Tensor, label: tf.Tensor) -> tuple[tf.Tensor, tf.Tensor]:
